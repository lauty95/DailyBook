<template>
    <div class="entry-container mb-3 pointer p-2" @click="$router.push({ name: 'entry', params: { id: 10 } })">
        ...
        <div class="entry-description">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rem obcaecati laudantium praesentium magnam recusandae
            autem dignissimos maxime vitae mollitia aliquid.
        </div>
    </div>
</template>
